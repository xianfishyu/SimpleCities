...
public partial class RoadGraphV3System : Node2D
{
    ...
    public bool TryFindSurfaceHitsInRect(
        ...
        Application.TryFindSurfaceHitsInRect(rect, out hits);
    ...
    public long GetSlotTotalBytes(string slotId) =>
        Application.GetSlotTotalBytes(slotId);
    ...
    public string? GetSlotRoadNetworkJson(string slotId) =>
        Application.GetSlotRoadNetworkJson(slotId);

    public string? GetSlotFormatFamily(string slotId) =>
        Application.GetSlotFormatFamily(slotId);
    ...
    public bool GetSlotRoadNetworkHasPayload(string slotId) =>
        Application.GetSlotRoadNetworkHasPayload(slotId);

    public int GetSlotRoadNetworkPayloadLength(string slotId) =>
        Application.GetSlotRoadNetworkPayloadLength(slotId);
    ...
    public bool GetSlotThumbnailHasFile(string slotId) =>
        Application.GetSlotThumbnailHasFile(slotId);
    ...
    public bool GetSlotIsComplete(string slotId) =>
        Application.GetSlotIsComplete(slotId);

...
> 编写日期：2026-08-20
>
> 事实基线：2026-08-20 当前工作树中的 `Scripts/Road/`、`Scripts/Tools/`、`Scripts/UI/`、`Scripts/Core/Save*`、道路与存档自动化、本轮 CLI/Godot headless/导出复验、既有 Godot MCP 历史运行时证据、V2 性能基线及 [第二代道路系统迭代设计指南](road-system-v2-gen.md)。
>

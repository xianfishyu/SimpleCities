...
2026-09-13，V4-20（[#21](https://github.com/xianfishyu/SimpleCities/issues/21)）完成当前容量的四档实测及历史资源基线，详见[性能报告](../performance/v4-20-baseline.md)。规范道路边计数冻结为 `RoadSnapshot.EdgeCount`；用户已确认25/50/100米档各10K、200米档采用几何上限9,680边满铺，后者另配合法折线补充场景，144 FPS与100–300 ms目标不变。当前256边实现准入尚未扩容，因此本次使用240边，未冒充目标规模通过。
...
| 性能 | V4-20已冻结规范道路边计数、四格建造/八格改造及本次硬件/窗口；目标规模数据集、正式Release性能与长尾处置由#24/#25完成 |

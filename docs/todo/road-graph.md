...
| Geometry                   | Edge 只保存折线 waypoint                    | 统一契约、直线和 cubic Bézier 已完成；尚未集成 Edge | 2.5～2.6 继续实现其余曲线、序列化和权威拓扑运算              |

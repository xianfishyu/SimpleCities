...
| Geometry                   | Edge 只保存折线 waypoint                    | 统一契约、直线、cubic Bézier 及其序列化已完成；尚未集成 Edge | 2.5～2.6 继续实现其余曲线和权威拓扑运算              |

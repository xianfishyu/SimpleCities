...
- `V3SaveOperationUiStateTests`：null 结果、成功、Admission/Prepare/Preflight 提交前失败、in-progress busy、observer warning（空/多 warning 拼接）、IsTerminal 与 Cancelling 状态映射。

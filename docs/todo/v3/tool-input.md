...
- [ ] **2.4 将成功 full reset 作为旧图工具状态的原子失效边界**
  ...
  - 仍缺（保持开放）：平行 Edge 完整工具矩阵、真实 renderer/tool/slot observer/cleanup 组合、逐关键 Load Preflight Resource 故障及完整故障矩阵仍需协作验证。

...
| 1.4 | 暂停菜单没有异步 Save/Load/Delete 的独占状态机 | 开放（部分实现） | operation/render token、generation、busy、Escape、退出收敛、indexed 四类 surface 与 placement/拆除/改造 admission 已接入；补齐其余命令与结果矩阵 |

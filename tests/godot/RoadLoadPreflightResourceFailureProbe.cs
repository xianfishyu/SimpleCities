...
public partial class RoadLoadPreflightResourceFailureProbe : RefCounted
{
        ...
        RoadRenderer renderer)
    {
        ArgumentNullException.ThrowIfNull(saveManager);
        ArgumentNullException.ThrowIfNull(renderer);
        saveManager.ArmNextAggregateLoadRoadMeshFactoryPreflightObservation(renderer);
        _saveManager = saveManager;
        _renderer = renderer;
    }
    ...
    public bool IsAggregateLoadRoadMeshFactoryPreflightObservationArmed() =>
        _saveManager?.IsAggregateLoadRoadMeshFactoryPreflightObservationArmed() ?? false;

    public int GetAggregateLoadRoadMeshFactoryPreflightObservationCount() =>
        _saveManager?.GetAggregateLoadRoadMeshFactoryPreflightObservationCount() ?? 0;

    public bool DidAggregateLoadRoadMeshFactoryPreflightObservationRunOnMainThread() =>
        _saveManager?.DidAggregateLoadRoadMeshFactoryPreflightObservationRunOnMainThread() ?? false;

    public int GetAggregateLoadRoadMeshFactoryPreflightObservedPhase() =>
        _saveManager?.GetAggregateLoadRoadMeshFactoryPreflightObservedPhase() ?? -1;

    public int GetAggregateLoadRoadMeshFactoryPreflightPlanCount() =>
        _saveManager?.GetAggregateLoadRoadMeshFactoryPreflightPlanCount() ?? -1;

    public string GetAggregateLoadRoadMeshFactoryPreflightFirstParticipantID() =>
        _saveManager?.GetAggregateLoadRoadMeshFactoryPreflightFirstParticipantID() ?? string.Empty;

    public string GetAggregateLoadRoadMeshFactoryPreflightSecondParticipantID() =>
        _saveManager?.GetAggregateLoadRoadMeshFactoryPreflightSecondParticipantID() ?? string.Empty;

    public int GetAggregateLoadRoadMeshFactoryPreflightTargetEdgeCount() =>
        _saveManager?.GetAggregateLoadRoadMeshFactoryPreflightTargetEdgeCount() ?? -1;

    public string GetAggregateLoadRoadMeshFactoryPreflightObservedSlotID() =>
        _saveManager?.GetAggregateLoadRoadMeshFactoryPreflightObservedSlotID() ?? string.Empty;

    public int GetAggregateLoadRoadMeshFactoryPreflightSourceParticipantCount() =>
        _saveManager?.GetAggregateLoadRoadMeshFactoryPreflightSourceParticipantCount() ?? -1;

    public int GetAggregateLoadRoadMeshFactoryPreflightRoadVertexCount() =>
        _saveManager?.GetAggregateLoadRoadMeshFactoryPreflightRoadVertexCount() ?? -1;

    public int GetAggregateLoadRoadMeshFactoryPreflightSurfacePrimitiveCount() =>
        _saveManager?.GetAggregateLoadRoadMeshFactoryPreflightSurfacePrimitiveCount() ?? -1;

    public int GetAggregateLoadRoadMeshFactoryPreflightNodeMarkerCount() =>
        _saveManager?.GetAggregateLoadRoadMeshFactoryPreflightNodeMarkerCount() ?? -1;
    ...
    public void ArmAggregateLoadRoadSurfaceSnapshotFailure(
        SaveManager saveManager,
        RoadRenderer renderer)
    {
        ArgumentNullException.ThrowIfNull(saveManager);
        ArgumentNullException.ThrowIfNull(renderer);
        saveManager.ArmNextAggregateLoadRoadSurfaceSnapshotPreflightObservation(renderer);
        _saveManager = saveManager;
        _renderer = renderer;
    }
    ...
    public bool IsAggregateLoadRoadSurfaceSnapshotPreflightObservationArmed() =>
        _saveManager?.IsAggregateLoadRoadSurfaceSnapshotPreflightObservationArmed() ?? false;

    public int GetAggregateLoadRoadSurfaceSnapshotPreflightObservationCount() =>
        _saveManager?.GetAggregateLoadRoadSurfaceSnapshotPreflightObservationCount() ?? 0;

    public bool DidAggregateLoadRoadSurfaceSnapshotPreflightObservationRunOnMainThread() =>
        _saveManager?.DidAggregateLoadRoadSurfaceSnapshotPreflightObservationRunOnMainThread() ?? false;

    public int GetAggregateLoadRoadSurfaceSnapshotPreflightObservedPhase() =>
        _saveManager?.GetAggregateLoadRoadSurfaceSnapshotPreflightObservedPhase() ?? -1;

    public int GetAggregateLoadRoadSurfaceSnapshotPreflightPlanCount() =>
        _saveManager?.GetAggregateLoadRoadSurfaceSnapshotPreflightPlanCount() ?? -1;

    public string GetAggregateLoadRoadSurfaceSnapshotPreflightFirstParticipantID() =>
        _saveManager?.GetAggregateLoadRoadSurfaceSnapshotPreflightFirstParticipantID() ?? string.Empty;

    public string GetAggregateLoadRoadSurfaceSnapshotPreflightSecondParticipantID() =>
        _saveManager?.GetAggregateLoadRoadSurfaceSnapshotPreflightSecondParticipantID() ?? string.Empty;

    public int GetAggregateLoadRoadSurfaceSnapshotPreflightTargetEdgeCount() =>
        _saveManager?.GetAggregateLoadRoadSurfaceSnapshotPreflightTargetEdgeCount() ?? -1;

    public string GetAggregateLoadRoadSurfaceSnapshotPreflightObservedSlotID() =>
        _saveManager?.GetAggregateLoadRoadSurfaceSnapshotPreflightObservedSlotID() ?? string.Empty;

    public int GetAggregateLoadRoadSurfaceSnapshotPreflightSourceParticipantCount() =>
        _saveManager?.GetAggregateLoadRoadSurfaceSnapshotPreflightSourceParticipantCount() ?? -1;

    public int GetAggregateLoadRoadSurfaceSnapshotPreflightRoadVertexCount() =>
        _saveManager?.GetAggregateLoadRoadSurfaceSnapshotPreflightRoadVertexCount() ?? -1;

    public int GetAggregateLoadRoadSurfaceSnapshotPreflightSurfacePrimitiveCount() =>
        _saveManager?.GetAggregateLoadRoadSurfaceSnapshotPreflightSurfacePrimitiveCount() ?? -1;
    ...
    public bool IsAggregateLoadResourcePreflightObservationArmed() =>
        _saveManager?.IsAggregateLoadResourcePreflightObservationArmed() ?? false;

    public int GetAggregateLoadResourcePreflightObservationCount() =>
        _saveManager?.GetAggregateLoadResourcePreflightObservationCount() ?? 0;

    public bool DidAggregateLoadResourcePreflightObservationRunOnMainThread() =>
        _saveManager?.DidAggregateLoadResourcePreflightObservationRunOnMainThread() ?? false;

    public int GetAggregateLoadResourcePreflightObservedPhase() =>
        _saveManager?.GetAggregateLoadResourcePreflightObservedPhase() ?? -1;

    public int GetAggregateLoadResourcePreflightPlanCount() =>
        _saveManager?.GetAggregateLoadResourcePreflightPlanCount() ?? -1;

    public string GetAggregateLoadResourcePreflightFirstParticipantID() =>
        _saveManager?.GetAggregateLoadResourcePreflightFirstParticipantID() ?? string.Empty;

    public string GetAggregateLoadResourcePreflightSecondParticipantID() =>
        _saveManager?.GetAggregateLoadResourcePreflightSecondParticipantID() ?? string.Empty;

    public int GetAggregateLoadResourcePreflightTargetEdgeCount() =>
        _saveManager?.GetAggregateLoadResourcePreflightTargetEdgeCount() ?? -1;

    public string GetAggregateLoadResourcePreflightObservedSlotID() =>
        _saveManager?.GetAggregateLoadResourcePreflightObservedSlotID() ?? string.Empty;

    public int GetAggregateLoadResourcePreflightSourceParticipantCount() =>
        _saveManager?.GetAggregateLoadResourcePreflightSourceParticipantCount() ?? -1;

    public int GetAggregateLoadResourcePreflightRoadVertexCount() =>
        _saveManager?.GetAggregateLoadResourcePreflightRoadVertexCount() ?? -1;

    public int GetAggregateLoadResourcePreflightSurfacePrimitiveCount() =>
        _saveManager?.GetAggregateLoadResourcePreflightSurfacePrimitiveCount() ?? -1;

    public int GetAggregateLoadResourcePreflightNodeMarkerCount() =>
        _saveManager?.GetAggregateLoadResourcePreflightNodeMarkerCount() ?? -1;
    ...
    public bool DidAggregateLoadSlotTargetCommitBoundaryProbeRunOnMainThread() =>
        _saveManager?.DidAggregateLoadSlotTargetCommitBoundaryProbeRunOnMainThread() ?? false;

    public int GetAggregateLoadSlotTargetCommitBoundaryPlanCount() =>
        _saveManager?.GetAggregateLoadSlotTargetCommitBoundaryPlanCount() ?? -1;

    public string GetAggregateLoadSlotTargetCommitBoundaryFirstParticipantID() =>
        _saveManager?.GetAggregateLoadSlotTargetCommitBoundaryFirstParticipantID() ?? string.Empty;

    public string GetAggregateLoadSlotTargetCommitBoundarySecondParticipantID() =>
        _saveManager?.GetAggregateLoadSlotTargetCommitBoundarySecondParticipantID() ?? string.Empty;

    public string GetAggregateLoadSlotTargetCommitBoundaryThirdParticipantID() =>
        _saveManager?.GetAggregateLoadSlotTargetCommitBoundaryThirdParticipantID() ?? string.Empty;

    public string GetAggregateLoadSlotTargetCommitBoundaryFourthParticipantID() =>
        _saveManager?.GetAggregateLoadSlotTargetCommitBoundaryFourthParticipantID() ?? string.Empty;

    public int GetAggregateLoadSlotTargetCommitBoundaryTargetEdgeCount() =>
        _saveManager?.GetAggregateLoadSlotTargetCommitBoundaryTargetEdgeCount() ?? -1;

    public string GetAggregateLoadSlotTargetCommitBoundaryObservedSlotID() =>
        _saveManager?.GetAggregateLoadSlotTargetCommitBoundaryObservedSlotID() ?? string.Empty;

    public int GetAggregateLoadSlotTargetCommitBoundarySourceParticipantCount() =>
        _saveManager?.GetAggregateLoadSlotTargetCommitBoundarySourceParticipantCount() ?? -1;

    public int GetAggregateLoadSlotTargetCommitBoundaryRoadVertexCount() =>
        _saveManager?.GetAggregateLoadSlotTargetCommitBoundaryRoadVertexCount() ?? -1;

    public int GetAggregateLoadSlotTargetCommitBoundarySurfacePrimitiveCount() =>
        _saveManager?.GetAggregateLoadSlotTargetCommitBoundarySurfacePrimitiveCount() ?? -1;

    public int GetAggregateLoadSlotTargetCommitBoundaryNodeMarkerCount() =>
        _saveManager?.GetAggregateLoadSlotTargetCommitBoundaryNodeMarkerCount() ?? -1;
...
public partial class SaveManager
{
    ...
    private bool _aggregateLoadSlotTargetCommitBoundaryProbeRanOnMainThread;
    private int _aggregateLoadSlotTargetCommitBoundaryPlanCount = -1;
    private string _aggregateLoadSlotTargetCommitBoundaryFirstParticipantID = string.Empty;
    private string _aggregateLoadSlotTargetCommitBoundarySecondParticipantID = string.Empty;
    private string _aggregateLoadSlotTargetCommitBoundaryThirdParticipantID = string.Empty;
    private string _aggregateLoadSlotTargetCommitBoundaryFourthParticipantID = string.Empty;
    private int _aggregateLoadSlotTargetCommitBoundaryTargetEdgeCount = -1;
    private string _aggregateLoadSlotTargetCommitBoundaryObservedSlotID = string.Empty;
    private int _aggregateLoadSlotTargetCommitBoundarySourceParticipantCount = -1;
    private int _aggregateLoadSlotTargetCommitBoundaryRoadVertexCount = -1;
    private int _aggregateLoadSlotTargetCommitBoundarySurfacePrimitiveCount = -1;
    private int _aggregateLoadSlotTargetCommitBoundaryNodeMarkerCount = -1;
        ...
        string failureName)
    {
        ...
        {
            throw new InvalidOperationException(
                $"Aggregate Load {failureName} observation targeted a different RoadRenderer.");
        }
        if (!failureArmed)
        {
            throw new InvalidOperationException(
                $"Aggregate Load {failureName} failure probe was not armed at renderer preflight.");
        }
    ...
    private void ArmNextAggregateLoadRendererPreflightObservation(
        RoadRenderer renderer,
        AggregateLoadRendererPreflightProbeState state,
        Action<RoadRenderer> armFailure,
        string failureName)
    {
        ArgumentNullException.ThrowIfNull(renderer);
        if (IsOperationBusy)
        ...
        {
            throw new InvalidOperationException(
                $"Aggregate Load {failureName} observation is already armed.");
        }

        armFailure(renderer);
        state.Observation = AggregateLoadRendererPreflightObservation.Empty;
        state.Armed = true;
    ...
    internal void ArmNextAggregateLoadResourcePreflightObservation(
        ...
        ArmNextAggregateLoadRendererPreflightObservation(
            renderer,
            _aggregateLoadResourcePreflight,
            static currentRenderer => currentRenderer.ArmNextAggregateLoadResourcePreflightFailure(),
            "resource preflight");

    internal bool IsAggregateLoadResourcePreflightObservationArmed() =>
        _aggregateLoadResourcePreflight.Armed;

    internal int GetAggregateLoadResourcePreflightObservationCount() =>
        _aggregateLoadResourcePreflight.Count;

    internal bool DidAggregateLoadResourcePreflightObservationRunOnMainThread() =>
        _aggregateLoadResourcePreflight.Observation.RanOnMainThread;

    internal int GetAggregateLoadResourcePreflightObservedPhase() =>
        _aggregateLoadResourcePreflight.Observation.Phase;

    internal int GetAggregateLoadResourcePreflightPlanCount() =>
        _aggregateLoadResourcePreflight.Observation.PlanCount;

    internal string GetAggregateLoadResourcePreflightFirstParticipantID() =>
        _aggregateLoadResourcePreflight.Observation.FirstParticipantID;

    internal string GetAggregateLoadResourcePreflightSecondParticipantID() =>
        _aggregateLoadResourcePreflight.Observation.SecondParticipantID;

    internal int GetAggregateLoadResourcePreflightTargetEdgeCount() =>
        _aggregateLoadResourcePreflight.Observation.TargetEdgeCount;

    internal string GetAggregateLoadResourcePreflightObservedSlotID() =>
        _aggregateLoadResourcePreflight.Observation.SlotID;

    internal int GetAggregateLoadResourcePreflightSourceParticipantCount() =>
        _aggregateLoadResourcePreflight.Observation.SourceParticipantCount;

    internal int GetAggregateLoadResourcePreflightRoadVertexCount() =>
        _aggregateLoadResourcePreflight.Observation.RoadVertexCount;

    internal int GetAggregateLoadResourcePreflightSurfacePrimitiveCount() =>
        _aggregateLoadResourcePreflight.Observation.SurfacePrimitiveCount;
    ...
    internal void ArmNextAggregateLoadRoadSurfaceSnapshotPreflightObservation(
        RoadRenderer renderer) =>
        ArmNextAggregateLoadRendererPreflightObservation(
            renderer,
            _aggregateLoadRoadSurfaceSnapshotPreflight,
            static currentRenderer => currentRenderer.ArmNextAggregateLoadRoadSurfaceSnapshotFailure(),
            "road-surface snapshot");

    internal bool IsAggregateLoadRoadSurfaceSnapshotPreflightObservationArmed() =>
        _aggregateLoadRoadSurfaceSnapshotPreflight.Armed;

    internal int GetAggregateLoadRoadSurfaceSnapshotPreflightObservationCount() =>
        _aggregateLoadRoadSurfaceSnapshotPreflight.Count;

    internal bool DidAggregateLoadRoadSurfaceSnapshotPreflightObservationRunOnMainThread() =>
        _aggregateLoadRoadSurfaceSnapshotPreflight.Observation.RanOnMainThread;

    internal int GetAggregateLoadRoadSurfaceSnapshotPreflightObservedPhase() =>
        _aggregateLoadRoadSurfaceSnapshotPreflight.Observation.Phase;

    internal int GetAggregateLoadRoadSurfaceSnapshotPreflightPlanCount() =>
        _aggregateLoadRoadSurfaceSnapshotPreflight.Observation.PlanCount;

    internal string GetAggregateLoadRoadSurfaceSnapshotPreflightFirstParticipantID() =>
        _aggregateLoadRoadSurfaceSnapshotPreflight.Observation.FirstParticipantID;

    internal string GetAggregateLoadRoadSurfaceSnapshotPreflightSecondParticipantID() =>
        _aggregateLoadRoadSurfaceSnapshotPreflight.Observation.SecondParticipantID;

    internal int GetAggregateLoadRoadSurfaceSnapshotPreflightTargetEdgeCount() =>
        _aggregateLoadRoadSurfaceSnapshotPreflight.Observation.TargetEdgeCount;

    internal string GetAggregateLoadRoadSurfaceSnapshotPreflightObservedSlotID() =>
        _aggregateLoadRoadSurfaceSnapshotPreflight.Observation.SlotID;

    internal int GetAggregateLoadRoadSurfaceSnapshotPreflightSourceParticipantCount() =>
        _aggregateLoadRoadSurfaceSnapshotPreflight.Observation.SourceParticipantCount;

    internal int GetAggregateLoadRoadSurfaceSnapshotPreflightRoadVertexCount() =>
        _aggregateLoadRoadSurfaceSnapshotPreflight.Observation.RoadVertexCount;

    internal int GetAggregateLoadRoadSurfaceSnapshotPreflightSurfacePrimitiveCount() =>
        _aggregateLoadRoadSurfaceSnapshotPreflight.Observation.SurfacePrimitiveCount;
    ...
    private sealed class AggregateLoadRendererPreflightProbeState
    {
        ...
        internal AggregateLoadRendererPreflightObservation Observation { get; set; } =
            AggregateLoadRendererPreflightObservation.Empty;
    }
    ...
    private readonly record struct AggregateLoadRendererPreflightObservation(
        ...
        int NodeMarkerCount)
    {
        internal static AggregateLoadRendererPreflightObservation Empty { get; } = new(
            false,
            -1,
            -1,
            string.Empty,
        ...
        ref IStorageOperationLease operationLease)
    {
        ...
        _aggregateLoadSlotTargetCommitBoundaryProbeRanOnMainThread =
            _mainThreadID != 0 && System.Environment.CurrentManagedThreadId == _mainThreadID;
        _aggregateLoadSlotTargetCommitBoundaryPlanCount = preflightPlans.Count;
        _aggregateLoadSlotTargetCommitBoundaryFirstParticipantID =
            preflightPlans.Count > 0 ? preflightPlans[0].ParticipantID : string.Empty;
        _aggregateLoadSlotTargetCommitBoundarySecondParticipantID =
            preflightPlans.Count > 1 ? preflightPlans[1].ParticipantID : string.Empty;
        _aggregateLoadSlotTargetCommitBoundaryThirdParticipantID =
            preflightPlans.Count > 2 ? preflightPlans[2].ParticipantID : string.Empty;
        _aggregateLoadSlotTargetCommitBoundaryFourthParticipantID =
            preflightPlans.Count > 3 ? preflightPlans[3].ParticipantID : string.Empty;
        _aggregateLoadSlotTargetCommitBoundaryTargetEdgeCount = targetRevision.Edges.Count;
        _aggregateLoadSlotTargetCommitBoundaryObservedSlotID = prepared.Slot.SlotID;
    ...
    internal void ArmNextAggregateLoadSlotTargetCommitBoundaryGenerationMismatch()
    {
        ...
        _aggregateLoadSlotTargetCommitBoundaryProbeRanOnMainThread = false;
        _aggregateLoadSlotTargetCommitBoundaryPlanCount = -1;
        _aggregateLoadSlotTargetCommitBoundaryFirstParticipantID = string.Empty;
        _aggregateLoadSlotTargetCommitBoundarySecondParticipantID = string.Empty;
        _aggregateLoadSlotTargetCommitBoundaryThirdParticipantID = string.Empty;
        _aggregateLoadSlotTargetCommitBoundaryFourthParticipantID = string.Empty;
        _aggregateLoadSlotTargetCommitBoundaryTargetEdgeCount = -1;
        _aggregateLoadSlotTargetCommitBoundaryObservedSlotID = string.Empty;
        _aggregateLoadSlotTargetCommitBoundarySourceParticipantCount = -1;
        _aggregateLoadSlotTargetCommitBoundaryRoadVertexCount = -1;
        _aggregateLoadSlotTargetCommitBoundarySurfacePrimitiveCount = -1;
        _aggregateLoadSlotTargetCommitBoundaryNodeMarkerCount = -1;
    ...
    internal bool DidAggregateLoadSlotTargetCommitBoundaryProbeRunOnMainThread() =>
        _aggregateLoadSlotTargetCommitBoundaryProbeRanOnMainThread;

    internal int GetAggregateLoadSlotTargetCommitBoundaryPlanCount() =>
        _aggregateLoadSlotTargetCommitBoundaryPlanCount;

    internal string GetAggregateLoadSlotTargetCommitBoundaryFirstParticipantID() =>
        _aggregateLoadSlotTargetCommitBoundaryFirstParticipantID;

    internal string GetAggregateLoadSlotTargetCommitBoundarySecondParticipantID() =>
        _aggregateLoadSlotTargetCommitBoundarySecondParticipantID;

    internal string GetAggregateLoadSlotTargetCommitBoundaryThirdParticipantID() =>
        _aggregateLoadSlotTargetCommitBoundaryThirdParticipantID;

    internal string GetAggregateLoadSlotTargetCommitBoundaryFourthParticipantID() =>
        _aggregateLoadSlotTargetCommitBoundaryFourthParticipantID;

    internal int GetAggregateLoadSlotTargetCommitBoundaryTargetEdgeCount() =>
        _aggregateLoadSlotTargetCommitBoundaryTargetEdgeCount;

    internal string GetAggregateLoadSlotTargetCommitBoundaryObservedSlotID() =>
        _aggregateLoadSlotTargetCommitBoundaryObservedSlotID;

    internal int GetAggregateLoadSlotTargetCommitBoundarySourceParticipantCount() =>
        _aggregateLoadSlotTargetCommitBoundarySourceParticipantCount;

    internal int GetAggregateLoadSlotTargetCommitBoundaryRoadVertexCount() =>
        _aggregateLoadSlotTargetCommitBoundaryRoadVertexCount;

    internal int GetAggregateLoadSlotTargetCommitBoundarySurfacePrimitiveCount() =>
        _aggregateLoadSlotTargetCommitBoundarySurfacePrimitiveCount;

    internal int GetAggregateLoadSlotTargetCommitBoundaryNodeMarkerCount() =>
        _aggregateLoadSlotTargetCommitBoundaryNodeMarkerCount;
